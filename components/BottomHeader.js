        ...
        <View style={styles.myCommunities}>
            <View style={{
                ...
                <View style={{ flex: 2 / 3, flexDirection: 'row' }}>
                    <TouchableOpacity style={{ flex: 1 / 3, justifyContent: 'center', alignItems: 'center' }} onPress={handleAll}>
                        <Text
                            style={{
                                fontSize: 22,
                                fontWeight: "800",
                    ...
                    <TouchableOpacity style={{ flex: 1 / 3, justifyContent: 'center', alignItems: 'center' }} onPress={handleJoin}>
                        <Text style={{
                            fontSize: 22,
                            fontWeight: "800",
                            fontFamily: "Calibri",
                    ...
                    <TouchableOpacity style={{ flex: 1 / 3, justifyContent: 'center', alignItems: 'center' }} onPress={handlePending}>
                        <Text style={{
                            fontSize: 22,
                            fontWeight: "800",
                            fontFamily: "Calibri",
                ...
                <View style={{ flex: 1 / 3, justifyContent: 'center', alignItems: 'flex-end', flexDirection: 'row' }}>
