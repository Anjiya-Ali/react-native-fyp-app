...
const CreatingMyPostCard = (props) => {
    ...
    return (
        <View style={styles.myCommunities}>
            <View style={{
                ...
                <View style={{ flex: 0, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 15, marginTop: 10 }}>
                    <Text
                        style={{
                            fontSize: 12,
                            fontWeight: "300",
                    ...
                    >{description || "Your Description to the Post"}</Text>
                </View>
...
export default CreatingMyPostCard;