    ...
    try {
      if (password.trim() === "" || rePassword.trim() === "") {
        ...
        if(!result.success){
            ...
            if(role === "Student"){
              await CreateNotification(`Your password has been updated.`, "HomePage1", "Security Alert", userId)
            }
            else if(role === "Teacher"){
              await CreateNotification(`Your password has been updated.`, "TeacherHomePage", "Security Alert", userId)
            }
