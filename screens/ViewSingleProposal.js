//No fresh because no scroll view and adding scroll view se sab layout aage piche horaha
...
const ViewSingleProposal = ({ route }) => {
  ...
  useFocusEffect(
    React.useCallback(() => {
      const fetchData = async () => {
        setFlag(false);
        const json = await ViewSingleProposal(additionalData);
  ...
  return (
    <>
      {flag && (
        <>
          <Header heading="Proposal Description" navigate="MyProposals" flag={false} />
