...
const ProposalConfirmation = ({ route }) => {
//   const { teacher_name, title, total, rate } = route.params;
      ...
      <View style={styles.container}>
        <View style={styles.rectangleView}>
          ...
          <View>
            ...
            <Text style={styles.yourTotalIs}>
              Please hang tight, while we review your payment.
            </Text>
          </View>
        </View>
        <View style={styles.checkout}>
          <View style={styles.paybox2}>
            <Text style={[styles.pay]}>Your Order Summary is</Text>
              ...
              <View style={styles.rectangleView1}>
                ...
                >
                  <View style={styles.div3}>
                    <View>
                      <Text style={styles.yourTotalIs2}>{additionalData.title}</Text>
                      <Text style={[styles.text22, styles.textText]}>
                        {additionalData.teacher_name}
                      </Text>
                      <View style={styles.div3}>
                        <Text style={[styles.text1, styles.textTypo]}>
                          {Math.round(additionalData.rate)}
                        </Text>
                        <Image
                    ...
                    >
                      <Text style={[styles.yourTotalIs1]}>{additionalData.total}$</Text>
