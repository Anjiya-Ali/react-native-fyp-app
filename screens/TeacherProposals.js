...
const TeacherProposals = () => {
  ...
  const { GetAllProposalsT } = context;
  ...
  useFocusEffect(
    React.useCallback(() => {
      const fetchData = async () => {
        setFlag(false)
        const json = await GetAllProposalsT();
              ...
              <View key={index}>
                ...
                <View style={{
                  ...
                  <View style={{
                    ...
                    <View style={{ marginTop: 5, marginLeft: 36, width: "100%", flexDirection: 'row', justifyContent: 'flex-start',  }}>
                        <TouchableOpacity
