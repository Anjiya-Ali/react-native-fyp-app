...
const MyAcceptedInvitations = ({ route }) => {
  ...
  const { getAcceptedInvitations, acceptedInvitations, withdrawInvitation } =
    context1;
  ...
  useFocusEffect(
    React.useCallback(() => {
      const fetchData = async () => {
        setFlag(false);
        const json = await getAcceptedInvitations(additionalData);
  ...
  return (
    <>
      {flag && (
        ...
        >
          <Header heading="Course Partners" navigate="TeacherHomePage" />
