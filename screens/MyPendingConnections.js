...
const MyPendingConnections = () => {
  ...
  return (
    ...
    {flag && (
      ...
      {role === 'Teacher' ? <Header heading="My Pending Requests" navigate="TeacherHomePage" /> : <Header heading="My Pending Requests" navigate="HomePage1" />}
      <ScrollView
